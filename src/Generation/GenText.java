 ...
 */
public class GenText extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {    
    ...
    job.setJarByClass(GenText.class);
    job.setJobName("RandomTextGenerator");
    ...
    int numMapsPerHost = job.getInt("test.randomtextwrite.maps_per_host", 20);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new GenText(), args);
    System.exit(res);
  }
